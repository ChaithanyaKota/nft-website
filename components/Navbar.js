          ...
          <Link href="/">
            <a href="">
              <span className="items-center flex justify-center">
                <Image src="/Logo.svg" alt="Chiisai Logo" width={82} height={28} />
              </span>
            </a>
          </Link>
        </div>
          ...
          <li>
            <a href="" target="_blank" rel="noopener noreferrer">
              <span className="flex flex-col justify-center items-center py-2 px-4 relative">
                <Image src="/discord-icon.svg" alt="Social Media Image" width={20} height={20} />
              </span>
            </a>
          </li>
          <li>
            <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer">
              <span className="flex flex-col justify-center items-center py-2 px-4 relative">
                <Image src="/twitter-icon.svg" alt="Social Media Image" width={20} height={20} />
              </span>
            </a>
          </li>
          <li>
            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
              <span className="flex flex-col justify-center items-center py-2 px-4 relative">
                <Image src="/instagram-icon.svg" alt="Social Media Image" width={20} height={20} />
              </span>
            </a>
          </li>
        </ul>
